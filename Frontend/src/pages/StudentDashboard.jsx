...
const schemes = [
  ...
  },
  {
    ...
    eligibility: "Students of Class X | Indian nationality | Studying in India",
  ...
  },
  {
    ...
    eligibility: "SC/ST/OBC/Minority | Income < ₹6L/yr | Studying in India",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <aside className="lg:col-span-3 hidden lg:flex flex-col gap-4 min-w-[220px] max-w-xs text-sm">
            <div className="bg-white rounded-xl shadow p-4 flex flex-col gap-2">
              ...
              <button
                className="flex items-center gap-2 px-3 py-2 rounded hover:bg-green-50"
                onClick={() => navigate("/dashboard/student/check-status")}
              >
              ...
              <button
                className="flex items-center gap-2 px-3 py-2 rounded hover:bg-green-50"
                onClick={() => navigate("/dashboard/student/update-profile")}
              >
          ...
          <section className="lg:col-span-6 flex flex-col gap-6">
                  ...
                  >
                    ...
                    <div className="flex gap-2 mt-auto">
                      ...
                      <button
                        ...
                        onClick={() =>
                          navigate(`/dashboard/student/apply/${sch.id}`)
                        }
                      >
                        Apply Now
                      </button>
                  ...
                  return (
                    ...
                    >
                      <div className="font-semibold text-primary mb-2">
                        {app.data?.scheme || "Scholarship Application"}{" "}
            ...
            {/* Documents Section */}
            <div className="mb-8">
              <h2 className="text-lg font-bold text-primary mb-3">Documents</h2>
