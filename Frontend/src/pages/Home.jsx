  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-gradient-to-r from-green-300 to-green-700 text-white py-3 px-4 text-center text-xs sm:text-sm font-medium">
        Scholarships for Students | Empowering Education | Government of India
        Initiative
      </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 py-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <ul className="space-y-2">
              {updates.map((u, i) => (
                <li key={i} className="flex gap-2 text-xs text-gray-700">
                  <span className="text-secondary font-bold mt-0.5 flex-shrink-0">
                    ▶
                  </span>
                  <span>{u}</span>
                </li>
          ...
          <div className="card border-l-4 border-blue-400">
            ...
            <ul className="text-xs text-gray-700 space-y-2">
              <li>
                ...
                Last date for Post Matric Scholarship applications
              </li>
              <li>
                <span className="font-semibold text-blue-600">
                  15th Jan 2025:
                </span>{" "}
                Pragati Scholarship for Girls deadline
              </li>
              <li>
                <span className="font-semibold text-blue-600">
                  10th Nov 2024:
                </span>{" "}
                NTSE Application closes
              </li>
              <li>
                <span className="font-semibold text-blue-600">
                  15th Feb 2025:
                </span>{" "}
                Central Scholarship Scheme deadline
              </li>
            </ul>
          </div>
          ...
          <div className="card border-l-4 border-green-400">
            ...
            >
              ...
              <input
                ...
                placeholder="e.g. NSP2024XXXXXX"
                required
                value={checkAppId}
                onChange={(e) => setCheckAppId(e.target.value)}
              />
            ...
            {checkStatus && (
              <div
                className={`mt-3 text-sm font-bold p-2 rounded text-center ${
                  checkStatus === "Scholarship Granted"
              ...
              >
                Status:{" "}
                {checkStatus.includes("Pending") ? "Under Review" : checkStatus}
              </div>
            )}
            <div className="text-xs text-gray-500 mt-2">
              Track your scholarship application status instantly.
            </div>
          </div>
        ...
        <div className="card">
          ...
          <p className="text-sm text-gray-600 mb-4">
            The National Scholarship Portal is a one-stop solution for students
            to apply for various government scholarships. It streamlines the
            process from application to disbursement, ensuring transparency and
            efficiency.
          </p>
          ...
          <div className="space-y-3">
            <div className="border rounded-xl p-5 bg-green-50 border-green-200 flex flex-col gap-2 items-start shadow-sm">
              ...
              <button
                ...
                onClick={() => navigate("/post-matric-scholarship")}
              >
                Know more
              </button>
            </div>
            <div className="border rounded-xl p-5 bg-blue-50 border-blue-200 flex flex-col gap-2 items-start shadow-sm">
              ...
              <button
                className="btn-primary mt-2 text-xs px-4 py-1 self-end"
                onClick={() => navigate("/pragati-scholarship")}
              >
                Know more
              </button>
            </div>
            <div className="border rounded-xl p-5 bg-orange-50 border-orange-200 flex flex-col gap-2 items-start shadow-sm">
              ...
              <span className="text-xs text-gray-500">
                Merit Based | Class IX
              </span>
              <button
                className="btn-primary mt-2 text-xs px-4 py-1 self-end"
                onClick={() => navigate("/ntse-scholarship")}
              >
                Know more
              </button>
            </div>
            <div className="border rounded-xl p-5 bg-purple-50 border-purple-200 flex flex-col gap-2 items-start shadow-sm">
              ...
              <button
                className="btn-primary mt-2 text-xs px-4 py-1 self-end"
                onClick={() => navigate("/national-merit-scholarship")}
              >
                Know more
              </button>
            </div>
            <div className="border rounded-xl p-5 bg-yellow-50 border-yellow-200 flex flex-col gap-2 items-start shadow-sm">
              ...
              <button
                className="btn-primary mt-2 text-xs px-4 py-1 self-end"
                onClick={() => navigate("/central-scholarship")}
              >
                Know more
              </button>
            </div>
      ...
      <section className="max-w-7xl mx-auto w-full px-4 py-10 mb-8 bg-white rounded-xl shadow-lg border-4 border-primary">
        <h2 className="text-lg md:text-2xl font-bold text-primary mb-8 text-center tracking-widest uppercase">
          Numbers at a glance
        </h2>
