  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/dashboard/student/check-status"
          element={<CheckStatus />}
        />
        <Route
          path="/dashboard/student/update-profile"
          element={<UpdateProfile />}
        />
        <Route
          path="/dashboard/student/apply/:schemeId"
          element={<ScholarshipForm />}
        />
        <Route path="/dashboard/institute" element={<InstituteDashboard />} />
        <Route
          path="/dashboard/institute/applications"
        ...
        <Route
          path="/dashboard/state/institute-approvals"
          element={<OfficerInstituteApprovals />}
        />
        <Route path="/dashboard/ministry" element={<MinistryDashboard />} />
        <Route
          path="/post-matric-scholarship"
          element={<PostMatricScholarship />}
        />
        <Route path="/pragati-scholarship" element={<PragatiScholarship />} />
        <Route path="/ntse-scholarship" element={<NTSEScholarship />} />
        <Route
          path="/national-merit-scholarship"
          element={<NationalMeritScholarship />}
        />
